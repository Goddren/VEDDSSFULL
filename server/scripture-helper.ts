...
const scriptureWisdom: ScriptureWisdom[] = [
  {
...
export function getScriptureByIndex(index: number): ScriptureWisdom {
  return scriptureWisdom[index % scriptureWisdom.length];
}
