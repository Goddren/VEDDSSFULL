    ...
    lessons: [
      ...
      },
      {
        ...
        sections: [
          ...
          { heading: "Setting It Up", content: "Everything lives in the Prop Firm Challenge dashboard:\n• Toggle Prop Firm Mode and set your firm's daily drawdown %\n• Enable Consistency Enforcement and set your days quota\n• Set Max Single-Day Profit % to match your firm's rule (commonly 30–50%)\n• Optionally enable the Session Filter (London–NY overlap only) and Deep Reasoning Mode for maximum discipline", isWarning: false },
        ],
        keyTakeaways: ["The engine stops at 80% of your firm's drawdown limit — never rides the edge", "Both consistency rule types are enforced automatically: days quota and max single-day profit", "Risk trims automatically near your profit target — protecting the finish line like a veteran"],
      },
    ],
    assessment: {
      passingScore: 70,
