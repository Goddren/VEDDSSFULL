...
const LESSON_CONTENT: Record<number, CourseContent> = {
  ...
  1: {
    lessons: [
      ...
      {
        number: 7, title: "AI Tools for Nonprofit & Community Program Operations", timeEstimate: "11 min",
        sections: [
          { heading: "Where AI Saves the Most Time for Small Teams", content: "Community programs and small nonprofits rarely have dedicated admin staff. AI tools can absorb the highest-volume, lowest-judgment tasks:\n• Drafting grant proposals, donor letters, and newsletters (ChatGPT/Claude)\n• Summarizing long grant guidelines into a quick eligibility checklist\n• Generating first-draft social media content and workshop flyers (Canva AI)\n• Transcribing and summarizing board meeting recordings\n\nThe time saved on drafting frees staff and volunteers for the relationship-building work AI genuinely cannot replace." },
          { heading: "AI for Data & Impact Reporting", content: "Funders increasingly expect data-backed impact reports. AI tools can help:\n• Turn a spreadsheet of workshop attendance into a written summary paragraph for a grant report\n• Analyze open-text survey responses for common themes (useful for pre/post assessment data from Course 10)\n• Draft data visualizations descriptions and talking points for board presentations\n\nAlways have a human review AI-generated statistics before they go into an official report — AI can misstate numbers if the input data is ambiguous." },
          { heading: "Guardrails for Nonprofit AI Use", content: "• Never input donor or client personally identifiable information (PII) into a public AI tool unless it has a business/enterprise privacy agreement\n• Disclose AI involvement in donor communications where relevant — trust matters more than efficiency in fundraising relationships\n• Keep a human final-review step on anything representing your organization publicly (grant submissions, press statements, board reports)", isWarning: true },
        ],
        keyTakeaways: ["AI is most valuable for drafting, summarizing, and first-pass content — freeing time for relationship work", "AI can accelerate impact reporting but a human must verify any statistics before they go into official reports", "Never input donor/client PII into a public AI tool without an enterprise privacy agreement in place"],
      },
      {
        number: 8, title: "Teaching AI Literacy to Others: A Facilitator's Guide", timeEstimate: "10 min",
        sections: [
          { heading: "Meeting People Where They Are", content: "AI literacy audiences range from people who've never used ChatGPT to people using it daily but unaware of its limitations. Start every session by asking a show-of-hands question ('Who has used an AI chatbot before?') to calibrate your pacing instead of assuming a baseline." },
          { heading: "A Simple 30-Minute AI Literacy Session Outline", content: "0:00-0:05 — Hook: A live demo asking an AI tool a question the audience cares about\n0:05-0:15 — Core concept: AI learns patterns from data; it doesn't 'know' facts the way a person does, and it can be confidently wrong (hallucination)\n0:15-0:25 — Hands-on: Everyone tries a specific, useful prompt on their own phone (e.g., 'Help me write a budget-friendly grocery list for a family of 4')\n0:25-0:30 — Close: One actionable AI tool each person will try this week" },
          { heading: "Common Misconceptions to Address Head-On", content: "• 'AI will take my job' — reframe: AI changes tasks within jobs more than it eliminates whole jobs; the people who adapt fastest benefit most\n• 'AI is always right' — demonstrate a hallucination live (ask an AI a very specific, obscure factual question and show it can be confidently wrong) to build healthy skepticism\n• 'AI is only for tech people' — show a non-technical use case relevant to their life (meal planning, letter writing, resume help) in the first five minutes", isExample: true },
        ],
        keyTakeaways: ["Calibrate every AI literacy session to your specific audience's starting point — don't assume a baseline", "A hands-on 30-minute structure with a live hallucination demo builds both capability and healthy skepticism", "Meet skepticism about AI directly with relevant, non-technical use cases in the first few minutes"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "Before using AI to draft a nonprofit's impact report, what must a human do?", options: ["Nothing — AI reports are always accurate", "Verify any AI-generated statistics before they appear in an official report", "Delete the original spreadsheet data", "Submit the AI draft directly to the funder"], correct: 1, explanation: "AI can misstate numbers when input data is ambiguous. A human must always verify statistics before they go into an official grant or impact report representing the organization." },
        { q: "What is the recommended first step when teaching an AI literacy session to a mixed-experience audience?", options: ["Assume everyone has the same experience level", "Start with a show-of-hands question to calibrate pacing to the actual audience", "Skip straight to advanced use cases", "Only teach people who already use AI daily"], correct: 1, explanation: "Audiences range widely in AI experience. A quick calibration question (e.g., 'who has used a chatbot before?') lets a facilitator adjust pacing and examples to the actual room instead of assuming a baseline." },
      ],
    },
  },
  ...
  3: {
    lessons: [
      ...
      {
        number: 6, title: "Risk Management: Position Sizing & Capital Preservation", timeEstimate: "12 min",
        sections: [
          { heading: "The One Rule That Matters Most", content: "Every professional trading rule ultimately serves one goal: staying in the game long enough for your edge to play out. Risk 1-2% of your account per trade — not because it's a magic number, but because it means 10 consecutive losses (rare, but possible) only costs 10-20% of your account, not a wipeout." },
          { heading: "Position Sizing Formula", content: "Position Size = (Account Balance × Risk %) ÷ Stop Distance\n\nExample: $10,000 account, risking 1% ($100), stop loss is 20 pips away, and each pip on your position size is worth $5 per standard lot.\n$100 ÷ 20 pips = $5/pip needed → that maps to a specific lot size for your instrument.\n\nThe stop distance and account size determine position size — never pick a position size first and then figure out where the stop 'has to go.' That's backwards and leads to stops placed at illogical technical levels just to fit a lot size you already wanted." },
          { heading: "Drawdown Math: Why Losses Compound Against You", content: "Losses require disproportionately larger gains to recover:\n• 10% loss requires 11.1% gain to recover\n• 25% loss requires 33.3% gain to recover\n• 50% loss requires 100% gain to recover\n• 75% loss requires 300% gain to recover\n\nThis asymmetry is why capital preservation matters more than any single winning trade. Protecting against large losses protects your ability to compound gains over time.", isWarning: true },
        ],
        keyTakeaways: ["Risking 1-2% per trade keeps you in the game through inevitable losing streaks", "Position size is derived from your stop distance and risk % — never the reverse", "Large losses require disproportionately larger gains to recover — capital preservation is the foundation of long-term profitability"],
      },
      {
        number: 7, title: "Building Your First Trading Plan", timeEstimate: "11 min",
        sections: [
          { heading: "Why a Written Plan Beats a Mental One", content: "A trading plan written down and referenced before every session removes emotional decision-making in the moment. Without one, every trade becomes an improvised decision influenced by the last win or loss — which is exactly how discipline erodes." },
          { heading: "The Core Components of a Trading Plan", content: "1. Markets/instruments you trade (don't trade everything — specialize)\n2. Timeframes you analyze and the entry timeframe you execute on\n3. Setup criteria — the SPECIFIC conditions that must be true before you enter (not 'looks good')\n4. Risk per trade and maximum daily/weekly loss limit that stops you trading for the day/week\n5. Position sizing rule (see the risk management lesson)\n6. Trading hours — many strategies only work during specific sessions (e.g., London-NY overlap)\n7. Journal requirement — what you record after every trade, win or lose" },
          { heading: "Testing and Refining Your Plan", content: "A trading plan is a living document, not a one-time exercise:\n1. Backtest the setup criteria against historical charts — did they actually produce good trades?\n2. Paper trade the plan for at least 30-50 trades before risking real capital\n3. Review your journal weekly — are you actually following your own rules, or improvising?\n4. Refine ONE variable at a time (e.g., adjust the stop placement rule) — changing multiple things at once makes it impossible to know what improved or worsened results", isExample: true },
        ],
        keyTakeaways: ["A written trading plan removes in-the-moment emotional decision-making", "Every plan needs specific setup criteria, risk limits, position sizing, and a journal requirement", "Backtest and paper trade a plan for 30-50 trades before committing real capital, then refine one variable at a time"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "What is the correct order for determining position size?", options: ["Pick a lot size you like, then find a stop that fits it", "Determine account risk % and stop distance first, then calculate the position size from those", "Always use the same position size regardless of the trade", "Position size should match your emotional confidence in the trade"], correct: 1, explanation: "Position size is derived FROM your risk percentage and stop distance — never chosen first and then reverse-engineered into a stop placement. Doing it backwards leads to illogical stop placement." },
        { q: "Why is a written trading plan more effective than a mental one?", options: ["It looks more professional", "It removes in-the-moment emotional decision-making by defining rules in advance", "It guarantees profitability", "It is required by every broker"], correct: 1, explanation: "A written plan defines setup criteria, risk limits, and rules BEFORE you're in the emotional moment of a live trade — removing the improvisation that erodes discipline over time." },
      ],
    },
  },
  ...
  4: {
    lessons: [
      ...
      {
        number: 4, title: "Debt Elimination Strategies", timeEstimate: "10 min",
        sections: [
          { heading: "Good Debt vs. Bad Debt", content: "Not all debt is equal. Good debt builds an asset or earns more than it costs (a mortgage on an appreciating home, a business loan that generates revenue, federal student loans for a degree that raises earning power). Bad debt finances depreciating purchases or carries a high interest rate with no asset behind it — credit cards, payday loans, buy-now-pay-later on consumer goods.\n\nBefore attacking any balance, sort your debts into these two buckets. Your strategy differs for each." },
          { heading: "The Debt Snowball Method", content: "List every debt smallest balance to largest, ignoring interest rate. Pay minimums on everything except the smallest — throw every extra dollar at that one until it's gone. Then roll that payment into the next smallest.\n\nWhy it works: psychology, not math. Quick wins build momentum and prove the system works, which keeps people going long enough to finish. Dave Ramsey popularized this approach for exactly that reason." },
          { heading: "The Debt Avalanche Method", content: "List every debt highest interest rate to lowest. Pay minimums on everything except the highest-rate debt — throw every extra dollar there first.\n\nWhy it works: math. You pay less total interest over the life of your payoff than with the snowball. Best for people who are motivated by numbers rather than quick wins.\n\nExample: $3,000 credit card at 24% APR vs. $5,000 car loan at 6% APR — avalanche attacks the credit card first even though it's the smaller balance, because that 24% is bleeding you the most." },
          { heading: "Negotiating with Creditors", content: "Creditors would rather get paid something than nothing. If you're struggling:\n• Call and ask for a hardship program — many offer reduced rates or paused payments for 3-6 months\n• Ask for a lower APR if you have a history of on-time payments — a 2-minute phone call sometimes cuts your rate in half\n• For accounts already in collections, negotiate a 'pay for delete' — settle for less than owed in exchange for removal from your credit report (get it in writing before paying)", isExample: true },
        ],
        keyTakeaways: ["Sort debt into good (builds an asset) vs. bad (depreciating, high-interest) before strategizing", "Snowball = fastest psychological wins; Avalanche = lowest total interest paid", "A 2-minute call asking for a lower rate or hardship program can save hundreds of dollars"],
      },
      {
        number: 5, title: "Retirement & Long-Term Wealth Building", timeEstimate: "12 min",
        sections: [
          { heading: "Why Time Beats Timing", content: "Compound growth rewards early starters more than skilled starters. $200/month invested at age 25 growing at 8% annually becomes roughly $622,000 by age 65. The same $200/month starting at age 35 becomes roughly $272,000 by 65 — over half a million dollars less, purely from a 10-year delay.\n\nThe lesson: the exact investment you pick matters less than starting now with something reasonable (a low-cost index fund) rather than waiting for the 'perfect' plan." },
          { heading: "Retirement Account Types", content: "401(k) — Employer-sponsored. Contribute pre-tax, taxed on withdrawal in retirement. Many employers match a percentage — that match is free money; always contribute at least enough to capture the full match.\n\nTraditional IRA — Individual account, pre-tax contributions, similar tax treatment to a 401(k), $7,000/year contribution limit (2024, under 50).\n\nRoth IRA — Contribute after-tax dollars, but withdrawals in retirement are 100% tax-free, including all growth. Best for people who expect to be in a higher tax bracket later, or want tax-free growth on a long time horizon." },
          { heading: "The Order of Operations", content: "1. Contribute to your 401(k) up to the full employer match (free money)\n2. Pay off any high-interest debt (above ~7-8%)\n3. Build your full emergency fund (3-6 months expenses)\n4. Max out a Roth IRA if eligible\n5. Go back and increase 401(k) contributions beyond the match\n6. Taxable brokerage account for additional investing\n\nThis order balances immediate financial safety with long-term growth — never skip the emergency fund to chase investment returns." },
          { heading: "Index Funds: The Default Answer", content: "An index fund holds every company in a market index (like the S&P 500) automatically, with very low fees (often under 0.10% annually). Individual stock-picking rarely beats the market consistently — even most professional fund managers underperform simple index funds over 10+ year periods.\n\nFor most people building long-term wealth: a low-cost S&P 500 index fund (VOO, VTI, FXAIX) inside a 401(k) or IRA is the highest-probability path to retiring comfortably, without needing to actively manage anything." },
        ],
        keyTakeaways: ["Starting early beats picking the 'perfect' investment — compound growth rewards time above all", "Always capture your full employer 401(k) match first — it's guaranteed free money", "A low-cost S&P 500 index fund is the highest-probability path to long-term wealth for most people"],
      },
      {
        number: 6, title: "Insurance & Protecting What You Build", timeEstimate: "9 min",
        sections: [
          { heading: "Insurance Is Risk Transfer, Not an Investment", content: "Insurance exists to transfer catastrophic, low-probability financial risk to a company that pools it across millions of people. It is not designed to make you money — it's designed to keep one bad event from wiping out everything you've built.\n\nThe test for whether you need a type of coverage: could this event bankrupt me or derail my goals if it happened tomorrow? If yes, insure it. If it's a minor inconvenience you could absorb, self-insure by saving instead." },
          { heading: "The Essential Coverage Checklist", content: "Health insurance — medical bankruptcy is a leading cause of bankruptcy filings in the US; never go without coverage if you can get it through an employer, ACA marketplace, or Medicaid.\n\nAuto insurance — required by law in most states; carry liability limits well above the state minimum, since a serious accident can generate six-figure claims against you personally.\n\nRenters/homeowners insurance — often skipped by renters, but a $15-20/month renters policy covers your belongings and liability if someone is injured in your unit.\n\nTerm life insurance — if anyone depends on your income (kids, a spouse, a business), a 20-year term policy (not whole life) covering 10x your income costs very little for someone healthy and young." },
          { heading: "What to Skip", content: "Extended warranties on electronics — usually a poor value; the failure rate they cover is low and self-insuring (saving the premium) usually wins.\n\nWhole life insurance for most people — expensive, complicated, and the 'investment' component underperforms simply buying cheap term insurance and investing the difference in an index fund.\n\nCredit/identity theft insurance sold by credit card companies — most of these protections already exist for free under federal law (like the Fair Credit Billing Act).", isWarning: true },
        ],
        keyTakeaways: ["Insure catastrophic risks that could bankrupt you; self-insure smaller risks by saving instead", "Health, auto liability, and renters/homeowners coverage are the essential baseline for almost everyone", "Term life (not whole life) is the efficient way to protect dependents on a budget"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "What is the key difference between the debt snowball and debt avalanche methods?", options: ["Snowball targets highest interest first; avalanche targets smallest balance first", "Snowball targets smallest balance first for psychological wins; avalanche targets highest interest rate first to minimize total interest", "They are the same strategy with different names", "Avalanche only works for mortgage debt"], correct: 1, explanation: "The snowball method builds momentum with quick wins by paying off the smallest balance first, while the avalanche method minimizes total interest paid by targeting the highest interest rate first." },
        { q: "Why does starting retirement investing at 25 instead of 35 make such a large difference?", options: ["Younger investors get better interest rates", "Compound growth needs time — an extra 10 years compounding can add hundreds of thousands of dollars", "Retirement accounts are illegal to open after 35", "There is no real difference"], correct: 1, explanation: "Compound growth accelerates over time. A 10-year head start can result in several hundred thousand dollars more by retirement, even with identical monthly contributions." },
        { q: "What is the correct test for deciding whether you need a type of insurance coverage?", options: ["Whether your friends have it", "Whether the event could bankrupt you or derail your goals if it happened tomorrow", "Whether it's required by your employer", "Whether the premium is under $50/month"], correct: 1, explanation: "Insurance should cover catastrophic, low-probability risks that could otherwise bankrupt you or derail your financial goals. Smaller, absorbable risks are usually better self-insured by saving." },
      ],
    },
  },
  ...
  2: {
    lessons: [
      ...
      {
        number: 6, title: "Digital Accessibility & Inclusion", timeEstimate: "9 min",
        sections: [
          { heading: "Why Accessibility Matters", content: "Over 1 billion people worldwide live with some form of disability. Digital accessibility means designing and using technology so everyone — including people with visual, hearing, motor, or cognitive impairments — can participate fully.\n\nFor VEDD ambassadors running community workshops, this isn't optional — many grant funders (DOL, CDFI) explicitly require accessible program delivery as a condition of funding." },
          { heading: "Practical Accessibility Basics", content: "• Use built-in screen readers (VoiceOver on Mac, Narrator on Windows) to test how your content sounds to a blind user\n• Add alt text to every image you post or send — describe what it shows in one sentence\n• Choose high-contrast color combinations — dark text on light backgrounds, avoid red/green as your only signal\n• Caption every video — free tools like YouTube's auto-caption or Otter.ai make this fast\n• Keep font sizes at 16px minimum for body text on any workshop materials" },
          { heading: "Digital Divide & Community Programs", content: "Not everyone has reliable internet or a modern device. When designing a community financial literacy program:\n• Offer materials as printable PDFs, not just web links\n• Choose platforms that work on older phones and slower connections (SMS, basic Zoom, not always the newest app)\n• Partner with libraries and community centers that provide free internet access\n• Never assume everyone has a smartphone, a bank account, or reliable transportation to attend in person", isExample: true },
        ],
        keyTakeaways: ["Accessibility is often a grant funding requirement, not just a best practice", "Alt text, captions, and high-contrast design make content usable for people with disabilities", "Design community programs assuming variable internet access and device quality"],
      },
      {
        number: 7, title: "Remote Work & the Gig Economy", timeEstimate: "10 min",
        sections: [
          { heading: "The Shift to Distributed Work", content: "Remote and hybrid work are now permanent fixtures of the economy, not a pandemic-era exception. Understanding how to find, land, and succeed in remote roles is a core digital-economy skill — especially valuable for community members balancing caregiving, transportation limits, or geographic constraints." },
          { heading: "Where to Find Legitimate Remote & Freelance Work", content: "• FlexJobs, We Work Remotely, Remote.co — curated remote job boards (less spam than general job sites)\n• Upwork, Fiverr — freelance marketplaces for skills like writing, design, bookkeeping, virtual assistance\n• LinkedIn — filter job search by 'Remote' and follow companies known for distributed teams\n\nRed flag check: legitimate remote employers never ask you to pay for training, buy equipment upfront with a promise of reimbursement, or deposit a check and wire part of it back — these are classic job scams targeting people seeking remote work." },
          { heading: "1099 vs. W-2: Know What You're Signing Up For", content: "W-2 employee: taxes withheld automatically, often eligible for benefits, employer pays half of Social Security/Medicare tax.\n\n1099 independent contractor (gig work, freelancing): you receive gross pay with nothing withheld, you owe self-employment tax (both halves of Social Security/Medicare, ~15.3%), and you must set aside money for quarterly estimated taxes.\n\nRule of thumb for 1099 income: save 25-30% of every payment for taxes before you spend anything, in a separate account.", isWarning: true },
        ],
        keyTakeaways: ["Remote work skills are now core to employability — know the legitimate platforms and the scam red flags", "1099 income requires you to self-withhold 25-30% for taxes — nothing is taken out automatically", "Distributed work opens opportunity for people facing transportation or geographic barriers"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "Why is digital accessibility often a requirement, not just a nice-to-have, for community programs?", options: ["It looks more professional", "Grant funders like DOL and CDFI often require accessible program delivery as a funding condition", "It's required by every website host", "It only matters for large organizations"], correct: 1, explanation: "Many federal and CDFI grant programs explicitly require accessible program delivery — alt text, captions, printable materials — as a condition of receiving funding." },
        { q: "What is a major red flag that a 'remote job' offer is a scam?", options: ["The job is fully remote", "They ask you to deposit a check and wire part of it back", "The pay is listed as hourly", "The interview is conducted over video call"], correct: 1, explanation: "Legitimate employers never ask you to deposit a check and wire money back, or pay upfront for training or equipment. This is a classic overpayment/wire fraud scam targeting remote job seekers." },
      ],
    },
  },
  ...
  5: {
    lessons: [
      ...
      {
        number: 7, title: "DeFi Deep Dive: Lending, Staking & Liquidity Pools", timeEstimate: "14 min",
        sections: [
          { heading: "What Is DeFi?", content: "Decentralized Finance (DeFi) recreates traditional financial services — lending, borrowing, trading, earning interest — using smart contracts instead of banks or brokerages. No account application, no credit check, no geographic restriction. Anyone with a wallet and an internet connection can participate." },
          { heading: "Lending & Borrowing Protocols", content: "Platforms like Aave and Compound let you deposit crypto to earn interest (lending) or put up collateral to borrow against it (borrowing) — all automated by code.\n\nExample: Deposit $1,000 of ETH as collateral, borrow up to ~70-80% of its value in a stablecoin, without selling your ETH. If ETH's price drops too far, the protocol automatically liquidates your collateral to protect lenders — this is the core risk of borrowing against volatile assets." },
          { heading: "Staking: Earning Yield by Securing the Network", content: "Staking means locking up tokens to help validate transactions on a blockchain (like Solana or Ethereum), earning a yield in return — similar to earning interest, but you're providing a real service (network security) rather than just depositing money.\n\nSolana staking typically yields 5-8% annually and can be done directly through Phantom wallet with a few clicks — no third party required." },
          { heading: "Liquidity Pools & Impermanent Loss", content: "A liquidity pool holds two paired tokens (e.g., SOL/USDC) that traders swap against; you earn a share of trading fees by depositing into the pool.\n\nThe risk — impermanent loss — happens when the price ratio between the two tokens shifts after you deposit. You can end up with less total value than if you'd simply held both tokens separately. This is the single most misunderstood risk in DeFi and the reason many pools that look attractive on paper underperform simple holding.", isWarning: true },
        ],
        keyTakeaways: ["DeFi lending/borrowing runs on smart contracts with automatic liquidation risk — never over-borrow against volatile collateral", "Staking Solana or Ethereum earns yield for securing the network, typically 5-8% APY", "Impermanent loss can silently erode liquidity pool returns — understand it before depositing"],
      },
      {
        number: 8, title: "NFTs & Digital Ownership", timeEstimate: "10 min",
        sections: [
          { heading: "Beyond the Hype: What an NFT Actually Is", content: "A Non-Fungible Token (NFT) is a unique, provably-owned entry on a blockchain. Unlike a Bitcoin (which is identical and interchangeable with any other Bitcoin — 'fungible'), each NFT is one-of-a-kind and verifiably tracked to a single owner.\n\nBeyond digital art, real use cases include: event tickets that can't be counterfeited, proof of ownership for real-world assets, membership/access passes, and academic or professional credentials recorded permanently on-chain." },
          { heading: "How NFT Ownership Actually Works", content: "Buying an NFT doesn't usually transfer copyright — it transfers a token that proves you own that specific instance on the blockchain. The underlying image or file is often stored off-chain (on services like IPFS), with the blockchain token pointing to it.\n\nThis distinction matters: owning the NFT of a piece of art doesn't automatically mean you own the copyright to reproduce or sell that image commercially, unless the terms explicitly grant that." },
          { heading: "Spotting NFT Scams", content: "The NFT space has a high scam rate. Watch for:\n• Fake mint sites that copy a legitimate project's look — always verify the official link from the project's verified social account\n• 'Wallet drainer' links disguised as free mints or airdrops — connecting your wallet and signing can authorize a scammer to withdraw everything\n• Pump-and-dump projects with anonymous teams promising unrealistic returns\n\nRule: Never connect your wallet to a site you found through a random DM or comment — verify through the project's official channel first.", isWarning: true },
        ],
        keyTakeaways: ["An NFT proves unique ownership on-chain — it does not automatically transfer copyright to the underlying content", "Real NFT use cases extend well beyond art: tickets, credentials, membership access", "Never connect your wallet or sign a transaction from an unverified link — wallet drainers are a common scam"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "What is the main risk of borrowing against crypto collateral in a DeFi lending protocol?", options: ["Higher taxes than traditional loans", "Automatic liquidation if the collateral's price drops too far", "You must pass a credit check", "The loan terms can never be automated"], correct: 1, explanation: "DeFi loans are over-collateralized and automatically liquidated by smart contracts if the collateral value falls below a threshold, protecting lenders but creating real risk for borrowers during price drops." },
        { q: "What is impermanent loss in a liquidity pool?", options: ["A guaranteed loss that always occurs", "A tax on crypto withdrawals", "A reduction in total value caused by price divergence between the pooled tokens after depositing", "The trading fee charged by the pool"], correct: 2, explanation: "Impermanent loss occurs when the price ratio between two pooled tokens changes after deposit, potentially leaving you with less total value than if you had simply held the tokens separately." },
      ],
    },
  },
  ...
  6: {
    lessons: [
      ...
      {
        number: 6, title: "Statistics & Probability in Trading", timeEstimate: "10 min",
        sections: [
          { heading: "Expected Value: The Math That Actually Matters", content: "Expected value (EV) tells you the average outcome of a bet or trade if you repeated it many times. Formula: EV = (Win% × Avg Win) − (Loss% × Avg Loss).\n\nExample: A strategy wins 40% of the time for an average $150 gain, and loses 60% of the time for an average $50 loss.\nEV = (0.40 × $150) − (0.60 × $50) = $60 − $30 = +$30 per trade.\n\nThis strategy is profitable long-term even though it loses MORE OFTEN than it wins — because the wins are big enough relative to the losses. This is the entire mathematical foundation of professional trading and risk-reward ratios." },
          { heading: "Probability Doesn't Guarantee the Next Outcome", content: "If a coin has a 50% chance of heads, and you flip tails five times in a row, the next flip is still 50/50 — the coin has no memory. This is called the Gambler's Fallacy: believing that past independent outcomes affect future independent outcomes.\n\nIn trading, a strategy with a 60% historical win rate can still lose 5 trades in a row purely by chance. Understanding this prevents traders from abandoning a statistically sound strategy after a normal losing streak, or doubling risk to 'chase' a loss." },
          { heading: "Sample Size Matters", content: "A strategy that wins 7 out of 10 trades sounds great — but 10 trades is far too small a sample to draw a reliable conclusion. Random chance alone can produce a 70% win rate over a small sample even from a mediocre strategy.\n\nProfessional traders and data scientists generally want at least 100 data points (trades, or experiment trials) before trusting a win rate or average outcome. This is why VEDD's backtesting and paper trading modules track large trade counts before recommending a strategy go live." },
        ],
        keyTakeaways: ["Expected value — not win rate alone — determines whether a strategy is profitable long-term", "The Gambler's Fallacy is believing independent past outcomes predict the next one — they don't", "Small sample sizes (under ~100 trades) can produce misleadingly good or bad win rates purely by chance"],
      },
      {
        number: 7, title: "Career Paths in Fintech & Data Science", timeEstimate: "9 min",
        sections: [
          { heading: "The Fintech Job Landscape", content: "Fintech (financial technology) is one of the fastest-growing career sectors, blending finance, software engineering, and data science. Roles include: quantitative analyst (builds trading models), data engineer (manages financial data pipelines), backend developer (builds trading platforms), and product manager (designs financial apps)." },
          { heading: "Skills That Open Doors", content: "You don't need a finance degree to enter fintech. The most in-demand entry skills:\n• SQL — querying databases, used in nearly every data role\n• Python — the standard language for financial analysis, data science, and automation\n• Statistics — understanding probability, distributions, and hypothesis testing\n• Domain knowledge — understanding how markets, trading, or payments actually work (which you're building right now)\n\nFree resources to build these: Khan Academy (statistics), freeCodeCamp (Python/SQL), Kaggle (real datasets to practice on)." },
          { heading: "Building a Portfolio That Gets Noticed", content: "Employers in fintech and data roles care more about demonstrated projects than credentials alone.\n\nProject ideas using what you've learned in this course:\n• Build a spreadsheet backtester for a simple trading strategy and document your findings\n• Analyze a public dataset (stock prices, crypto data) and write up 3 insights you found\n• Publish your code on GitHub with a clear README explaining what it does and why\n\nA portfolio of 2-3 well-documented projects on GitHub often outweighs a degree in early-career fintech hiring.", isExample: true },
        ],
        keyTakeaways: ["Fintech careers don't require a finance degree — SQL, Python, and statistics are the real entry skills", "Free resources (Khan Academy, freeCodeCamp, Kaggle) can build job-ready skills without cost", "A small portfolio of documented projects on GitHub often matters more than credentials alone"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "What is the Gambler's Fallacy?", options: ["Believing a strategy with a good track record will keep winning", "Believing that past independent outcomes (like coin flips) influence the next independent outcome", "Betting more money than you can afford to lose", "Using statistics to evaluate a trading strategy"], correct: 1, explanation: "The Gambler's Fallacy is the mistaken belief that independent random events are connected — for example, thinking a coin is 'due' for heads after several tails. Each independent flip or trade has the same probability regardless of recent history." },
        { q: "Why is a 70% win rate over only 10 trades not very reliable?", options: ["10 trades is a large enough sample to trust fully", "Small sample sizes can produce misleadingly good or bad results purely by chance", "Win rate is never a useful statistic", "70% win rates are always fake"], correct: 1, explanation: "Small sample sizes (like 10 trades) are highly susceptible to random variance. Statisticians generally want at least ~100 data points before trusting a win rate as representative of a strategy's true performance." },
      ],
    },
  },
  ...
  7: {
    lessons: [
      ...
      {
        number: 6, title: "Algorithmic Bias Case Studies", timeEstimate: "11 min",
        sections: [
          { heading: "The Apple Card Credit Limit Controversy", content: "In 2019, Apple Card (issued by Goldman Sachs) faced public accusations that its credit-limit algorithm gave women dramatically lower limits than their husbands, despite shared finances and sometimes higher credit scores for the wife. Goldman Sachs denied intentionally discriminating, but the case became a landmark example of how an algorithm can produce discriminatory outcomes even when gender isn't an explicit input — because it can learn from proxies correlated with gender." },
          { heading: "The COMPAS Recidivism Algorithm", content: "COMPAS, used by US courts to predict a defendant's likelihood of reoffending, was found by a 2016 ProPublica investigation to falsely flag Black defendants as high-risk at nearly twice the rate of white defendants with similar histories. This is a widely cited example of how training data reflecting historical policing and sentencing patterns can encode and amplify existing societal bias into an algorithm treated as 'objective.'" },
          { heading: "Lessons for Financial AI", content: "Both cases share a pattern: an algorithm trained on historical data can reproduce and even amplify the biases embedded in that history, while appearing neutral because no explicit protected characteristic (race, gender) is used as input.\n\nFor VEDD and any financial AI tool: the safeguard is transparency (showing users what factors drove a decision), regular bias audits (checking outcomes across demographic groups), and keeping a human able to override or appeal automated decisions.", isWarning: true },
        ],
        keyTakeaways: ["Algorithms can discriminate even without using protected characteristics directly, through correlated proxies", "Historical training data can encode and amplify existing societal bias, making an algorithm's 'neutral' output misleading", "Transparency, regular bias audits, and human override ability are the core safeguards against algorithmic harm"],
      },
      {
        number: 7, title: "Building Ethical AI Policies for Your Organization", timeEstimate: "10 min",
        sections: [
          { heading: "Why Every Organization Using AI Needs a Policy", content: "Whether you're running a VEDD ambassador business, a nonprofit, or a community program, any use of AI tools (chatbots, automated scoring, content generation) should be governed by a written policy — both to protect the people you serve and to satisfy grant funder due-diligence requirements, which increasingly ask how organizations use AI responsibly." },
          { heading: "Core Elements of an AI Use Policy", content: "1. Purpose statement — what AI is used for and what it is NOT used for (e.g., 'AI generates draft content; a human reviews before publishing')\n2. Human oversight requirement — a named person responsible for reviewing AI-assisted decisions\n3. Data handling — what data is fed into AI tools, and confirmation it doesn't include sensitive personal information without consent\n4. Bias monitoring — a commitment to periodically check outcomes for disparities\n5. Disclosure — informing people when they're interacting with or being evaluated by an AI system" },
          { heading: "A Simple Template You Can Adapt", content: "\"[Organization] uses AI tools to [specific purpose]. All AI-generated content/decisions are reviewed by [role] before being finalized. We do not use AI to make final decisions about [sensitive category] without human review. We periodically audit AI-assisted outcomes for fairness. Individuals may request human review of any AI-assisted decision that affects them.\"\n\nAdapt the bracketed sections to your specific program — this template satisfies most funder and stakeholder expectations for responsible AI use.", isExample: true },
        ],
        keyTakeaways: ["A written AI use policy is increasingly expected by grant funders as part of responsible-use due diligence", "Core elements: purpose, human oversight, data handling, bias monitoring, and disclosure", "A simple adaptable template can satisfy most funder and stakeholder requirements"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "What made the COMPAS recidivism algorithm controversial?", options: ["It was too slow to be useful", "It falsely flagged Black defendants as high-risk at nearly twice the rate of white defendants with similar histories", "It was too expensive for most courts", "It only worked for federal cases"], correct: 1, explanation: "A 2016 ProPublica investigation found COMPAS disproportionately flagged Black defendants as high-risk, illustrating how training data reflecting historical bias can be encoded into an algorithm treated as objective." },
        { q: "What is a core element every organizational AI use policy should include?", options: ["A guarantee the AI is never wrong", "A named person responsible for human oversight of AI-assisted decisions", "A ban on all AI tools", "Legal indemnification for the AI vendor only"], correct: 1, explanation: "A written AI policy should name a person responsible for reviewing AI-assisted decisions, alongside purpose statements, data handling rules, bias monitoring, and disclosure to those affected." },
      ],
    },
  },
  ...
  8: {
    lessons: [
      ...
      {
        number: 7, title: "Interview Skills & Salary Negotiation", timeEstimate: "12 min",
        sections: [
          { heading: "The STAR Method for Behavioral Questions", content: "Most interviews include behavioral questions ('Tell me about a time you handled conflict'). Structure every answer with STAR:\n\nSituation — brief context\nTask — what you needed to accomplish\nAction — specifically what YOU did\nResult — the measurable outcome\n\nExample: 'A client (Situation) was frustrated about a delayed grant application (Task: keep them engaged). I set up weekly check-in calls and provided a written timeline (Action). They stayed with the program and the grant was submitted on time (Result).' Practice 5-6 STAR stories covering leadership, conflict, failure, and success before any interview." },
          { heading: "Questions to Ask Your Interviewer", content: "Asking thoughtful questions signals genuine interest and helps you evaluate the opportunity:\n• 'What does success look like in this role after 90 days?'\n• 'What's the biggest challenge the team is facing right now?'\n• 'How is performance evaluated here?'\n\nAvoid asking only about pay and benefits in the first conversation — save detailed compensation discussion for after an offer signal, unless the interviewer raises it first." },
          { heading: "Salary Negotiation Basics", content: "Never accept the first offer without at least one counter — most employers build in room to negotiate.\n\nScript: 'Thank you for the offer — I'm excited about this role. Based on my research and experience, I was hoping for something closer to $X. Is there flexibility there?'\n\nResearch your number first using Glassdoor, Levels.fyi, or Payscale for your role/location. If the base salary is fixed, negotiate other levers: start date, signing bonus, remote flexibility, or an earlier performance review.", isExample: true },
        ],
        keyTakeaways: ["Prepare 5-6 STAR-structured stories before any interview covering leadership, conflict, failure, success", "Ask about success metrics and challenges, not just compensation, in early interview rounds", "Always counter the first offer — research your market rate first and negotiate beyond just base salary"],
      },
      {
        number: 8, title: "Personal Branding Online", timeEstimate: "10 min",
        sections: [
          { heading: "Why Personal Branding Matters", content: "Employers, clients, and grant partners now research candidates online before ever meeting them. Your digital footprint — LinkedIn, a personal website, even your public social media — often forms someone's first impression before you say a word." },
          { heading: "LinkedIn Optimization Checklist", content: "• Professional headshot (not a cropped group photo)\n• Headline states what you DO, not just your job title (e.g., 'Financial Literacy Educator | VEDD Ambassador | Community Workshop Facilitator')\n• 'About' section written in first person telling your story, not a resume copy-paste\n• List real projects and measurable results, not just job titles\n• Request recommendations from people you've actually worked with — 3-5 strong ones beat 20 generic ones" },
          { heading: "Consistency Across Platforms", content: "Your name, headline, and story should be recognizable whether someone finds you on LinkedIn, a personal website, or Instagram. This doesn't mean posting identical content everywhere — it means the core identity ('who you help and how') stays consistent.\n\nFor VEDD ambassadors: your personal brand IS your business asset. People refer clients to people they trust, and trust is built through a consistent, credible online presence over time.", isExample: true },
        ],
        keyTakeaways: ["Employers and clients research you online before meeting — your digital footprint is your first impression", "Optimize LinkedIn with a real headline, first-person story, and specific project results", "Consistency in your core identity across platforms builds the trust that drives referrals"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "If a fixed salary offer can't be increased, what else can you negotiate?", options: ["Nothing — the negotiation is over", "Start date, signing bonus, remote flexibility, or an earlier performance review", "You should withdraw your application", "Ask a friend to negotiate on your behalf"], correct: 1, explanation: "When base salary is truly fixed, other levers remain negotiable: start date, signing bonus, remote/hybrid flexibility, additional PTO, or an earlier scheduled performance/raise review." },
        { q: "What should your LinkedIn headline communicate?", options: ["Only your current job title", "What you DO and who you help, not just a title", "Your salary expectations", "A list of every skill you have"], correct: 1, explanation: "An effective headline goes beyond a job title to communicate what you actually do and for whom — e.g., 'Financial Literacy Educator | VEDD Ambassador' — making it immediately clear to anyone viewing your profile." },
      ],
    },
  },
  ...
  9: {
    lessons: [
      ...
      {
        number: 8, title: "Multi-Timeframe Confluence", timeEstimate: "13 min",
        sections: [
          { heading: "Why One Timeframe Isn't Enough", content: "A setup that looks perfect on the 5-minute chart can be trading directly into major resistance on the 4-hour chart. Multi-timeframe (MTF) analysis means checking a higher timeframe for context before trusting a lower-timeframe entry signal — this is exactly how VEDD's SS AI Engine synthesizes 15m, 1H, and 4H data before confirming a signal." },
          { heading: "The Top-Down Approach", content: "1. Start on the highest relevant timeframe (4H or Daily) — identify the overall trend and major support/resistance zones\n2. Move to the medium timeframe (1H) — look for the trend structure within that higher-timeframe context\n3. Drop to the entry timeframe (5m-15m) — time your precise entry once the higher timeframes agree on direction\n\nConfluence means multiple timeframes are pointing the same direction at the same price zone — the highest-probability trades occur when 3 timeframes agree." },
          { heading: "Common MTF Mistakes", content: "• Trading a bullish 5-minute signal while the 4-hour chart shows a strong downtrend — the higher timeframe usually wins\n• Ignoring higher-timeframe resistance/support just because the lower timeframe 'looks clean'\n• Constantly flipping between timeframes mid-trade and second-guessing a valid entry — pick your timeframes before entering and stick to your plan", isWarning: true },
        ],
        keyTakeaways: ["Higher timeframes provide context; lower timeframes provide entry timing — never skip the higher-timeframe check", "The highest-probability trades occur when 3+ timeframes show confluence in the same direction", "Once your MTF analysis confirms an entry, don't abandon the plan by constantly re-checking other timeframes mid-trade"],
      },
      {
        number: 9, title: "Building & Testing Custom Indicators", timeEstimate: "15 min",
        sections: [
          { heading: "Why Build Your Own Indicator", content: "Off-the-shelf indicators (RSI, MACD, moving averages) are useful but generic — built for every market and every trader. A custom indicator, even a simple one, encodes YOUR specific edge: the exact pattern or condition you've noticed works for your strategy." },
          { heading: "Starting Simple: A Custom Composite Score", content: "You don't need to code from scratch. Start in a spreadsheet by combining existing indicators into one composite score:\n\nExample composite: Trend Score = (RSI above 50 ? +1 : -1) + (Price above 50 EMA ? +1 : -1) + (ADX above 25 ? +1 : 0)\n\nA score of +3 means all three conditions confirm a strong trend; a score near 0 means mixed signals — sit out. This simple weighted approach is the foundation of how more sophisticated algorithmic systems, including VEDD's, combine multiple signals into one confidence score." },
          { heading: "Backtesting Your Indicator Before Trusting It", content: "Never trade a new indicator on live money first. Backtest it against historical data:\n1. Define exact entry/exit rules based on your indicator\n2. Apply those rules to at least 100 historical setups\n3. Calculate win rate, average R:R, and max drawdown\n4. Only move to paper trading if the backtest shows a positive expected value\n\nVEDD's paper trading mode exists specifically for this validation step — prove an idea works before any real capital is at risk." },
        ],
        keyTakeaways: ["A custom indicator encodes your specific edge rather than relying on generic, one-size-fits-all tools", "Simple weighted composite scores (combining RSI, EMA, ADX) are an accessible starting point before coding anything complex", "Always backtest against 100+ historical setups and paper trade before risking real capital on a new indicator"],
      },
    ],
    assessment: {
      passingScore: 75,
      ...
      questions: [
        ...
        { q: "In multi-timeframe analysis, what does 'confluence' mean?", options: ["Using only one timeframe for precision", "Multiple timeframes pointing the same direction at the same price zone", "Switching timeframes constantly during a trade", "The exact moment a candle closes"], correct: 1, explanation: "Confluence means multiple timeframes agree — showing the same directional bias at the same price zone. The highest-probability trades occur when 3+ timeframes show this agreement." },
        { q: "Before trusting a new custom indicator, what should you do first?", options: ["Trade it immediately with a large position", "Backtest it against at least 100 historical setups, then paper trade it", "Share it publicly for feedback", "Combine it with 10 other indicators at once"], correct: 1, explanation: "A new indicator or strategy should be backtested against a meaningful sample (100+ historical setups) to calculate expected value, then validated further in paper trading before any real capital is risked." },
      ],
    },
  },
  ...
  10: {
    lessons: [
      ...
      {
        number: 6, title: "Forming and Registering a Nonprofit (501(c)(3) Basics)", timeEstimate: "14 min",
        sections: [
          { heading: "Do You Actually Need a Nonprofit?", content: "Not every community program needs its own 501(c)(3). Consider a fiscal sponsorship arrangement first — partnering with an existing nonprofit that accepts donations/grants on your program's behalf for a small administrative fee (typically 5-10%). This gets you grant-eligible immediately without the cost and delay of forming your own entity.\n\nForm your own nonprofit when: you have a distinct, ongoing mission, you need full control over governance and finances, and you're ready for the ongoing compliance burden (annual filings, board governance, audits for larger budgets)." },
          { heading: "The Formation Process, Step by Step", content: "1. Choose a name and confirm it's not taken in your state (Secretary of State business search)\n2. Recruit a board of directors — most states require at least 3 unrelated board members\n3. File Articles of Incorporation with your state (creates the legal nonprofit corporation, distinct from federal tax-exempt status)\n4. Write bylaws — the internal rules for how your board operates and makes decisions\n5. Get an EIN (Employer Identification Number) from the IRS — free, takes minutes online\n6. File Form 1023 (or the shorter 1023-EZ for small organizations under $50,000 projected annual revenue) with the IRS for 501(c)(3) tax-exempt status\n7. Register for state charitable solicitation if you plan to fundraise across state lines" },
          { heading: "1023 vs. 1023-EZ: Which Do You Need?", content: "Form 1023-EZ ($275 filing fee, much shorter): available if you project under $50,000 in annual gross receipts for the next 3 years and have under $250,000 in assets. Approval typically takes 2-4 weeks.\n\nForm 1023 (full version, $600 filing fee): required for larger organizations, more detailed narrative required about programs, finances, and governance. Approval can take 3-12 months.\n\nMost new VEDD-affiliated community programs qualify for the streamlined 1023-EZ — start there if you're eligible." },
          { heading: "After You're Approved: Ongoing Compliance", content: "501(c)(3) status isn't a one-time achievement — it comes with ongoing requirements:\n• File Form 990 (or 990-EZ/990-N for smaller orgs) with the IRS annually — this becomes public record\n• Maintain board meeting minutes and financial records\n• Renew state charitable registration annually in states where you fundraise\n• Avoid excessive 'private benefit' — nonprofit funds and assets must serve the mission, not personal enrichment\n\nMissing three consecutive years of Form 990 filings results in automatic revocation of tax-exempt status — this happens to smaller nonprofits more often than people realize.", isWarning: true },
        ],
        keyTakeaways: ["Fiscal sponsorship can make you grant-eligible immediately without forming your own nonprofit", "Form 1023-EZ (streamlined, $275) fits most small community programs under $50K projected revenue", "501(c)(3) status requires ongoing annual Form 990 filing — missing 3 years causes automatic revocation"],
      },
      {
        number: 7, title: "Nonprofit Board Governance & Fiduciary Duty", timeEstimate: "11 min",
        sections: [
          { heading: "The Three Fiduciary Duties Every Board Member Owes", content: "1. Duty of Care — make informed decisions, attend meetings, review financials before voting, ask questions rather than rubber-stamping\n2. Duty of Loyalty — put the organization's interests ahead of personal interests; disclose and recuse from any conflict of interest\n3. Duty of Obedience — ensure the organization follows its stated mission, bylaws, and all applicable laws\n\nBoard members can be held personally liable if they neglect these duties in a way that causes financial harm to the organization — this is why every board needs at least basic governance training, not just enthusiasm." },
          { heading: "Building an Effective Board", content: "A working board (not just a name on paper) typically includes:\n• A Treasurer who actually reviews financial statements monthly, not just at year-end\n• A mix of skills — at least one person with financial/accounting background, one with legal or compliance awareness, one with deep community connection\n• Term limits (e.g., 3-year terms, renewable twice) to keep the board refreshed with new perspective and prevent burnout or stagnation\n• A conflict-of-interest policy that every member signs annually" },
          { heading: "Common Governance Failures to Avoid", content: "• The founder who won't share control — a board that exists only to approve whatever the founder wants isn't fulfilling its legal oversight function, and funders increasingly scrutinize this\n• No documented meeting minutes — if it's not written down, it didn't happen for legal/audit purposes\n• Approving budgets without reviewing them line by line\n• Ignoring the annual Form 990 review — the board should see and approve this filing before it's submitted, since it's a public document reflecting the organization's finances", isWarning: true },
        ],
        keyTakeaways: ["Every board member owes duties of care, loyalty, and obedience — and can be personally liable for neglecting them", "Effective boards mix financial, legal, and community expertise with term limits to stay fresh", "Document every board decision in writing — undocumented decisions carry no legal weight in an audit or dispute"],
      },
      {
        number: 8, title: "Diversifying Your Program's Funding Beyond Grants", timeEstimate: "10 min",
        sections: [
          { heading: "Why Grant-Only Funding Is Risky", content: "Programs that rely on a single grant, or grants alone, face a funding cliff the moment that grant cycle ends. The nonprofit sector rule of thumb: no single funding source should represent more than 30-40% of your total budget. Diversification protects your program's survival." },
          { heading: "Individual Donor Fundraising", content: "Individual donors (not grants or corporations) provide the largest share of US charitable giving overall. Starting points:\n• A simple year-end appeal email/letter to everyone in your network describing specific impact and a specific ask\n• Recurring monthly giving programs — even $10/month donors add predictable, renewable revenue\n• Peer-to-peer campaigns — supporters fundraise on your behalf among their own networks (GoFundMe Charity, Classy, or Givebutter are common free/low-cost platforms)" },
          { heading: "Corporate & Community Partnerships", content: "Corporate funding beyond grants includes:\n• Sponsorships — a local business pays to have their name on your workshop series or event in exchange for visibility\n• Employee giving/matching programs — many employers match employee donations to nonprofits dollar-for-dollar; ask your donors if their employer offers this (Double the Donation is a free tool to check)\n• In-kind donations — venue space, printing, food for events — these reduce your cash costs even when they don't add dollars directly" },
          { heading: "Earned Revenue for Nonprofits", content: "Nonprofits are legally allowed to earn revenue from program-related activities without losing tax-exempt status, as long as it supports the mission:\n• Charging a modest fee for corporate workshops while keeping community workshops free\n• Selling branded merchandise or curriculum licenses to other organizations\n• Fee-for-service consulting for organizations wanting to replicate your program model\n\nThis is exactly the model VEDD Ambassadors already use — free community education funded in part by paid corporate/consulting work.", isExample: true },
        ],
        keyTakeaways: ["No single funding source should exceed 30-40% of your budget — diversify to survive funding cliffs", "Individual donors, especially recurring monthly givers, provide the largest and most stable share of nonprofit revenue nationally", "Nonprofits can legally earn program-related revenue (paid corporate workshops, licensing) without losing tax-exempt status"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "What is fiscal sponsorship?", options: ["A type of grant only available to large nonprofits", "Partnering with an existing nonprofit to receive grants/donations on your program's behalf before forming your own entity", "A government loan program for nonprofits", "The process of firing a nonprofit's board"], correct: 1, explanation: "Fiscal sponsorship lets a program operate under an existing 501(c)(3)'s tax-exempt status (for a small admin fee) so it can accept grants and tax-deductible donations immediately, without the time and cost of forming its own nonprofit." },
        { q: "Which IRS form should most small community programs under $50,000 projected revenue use to apply for 501(c)(3) status?", options: ["Form 990", "Form 1023 (full version)", "Form 1023-EZ", "Form W-9"], correct: 2, explanation: "Form 1023-EZ is the streamlined application for organizations projecting under $50,000 in annual gross receipts and under $250,000 in assets — lower fee, faster approval, and sufficient for most small community programs." },
        { q: "What is the nonprofit sector rule of thumb for funding diversification?", options: ["Rely on one major grant for stability", "No single funding source should represent more than 30-40% of total budget", "100% of funding should come from individual donors", "Grants should never be combined with earned revenue"], correct: 1, explanation: "Relying too heavily on one funding source creates a 'funding cliff' risk when that grant or donor relationship ends. Diversifying across grants, individual donors, corporate partners, and earned revenue protects program survival." },
      ],
    },
  },
  ...
  11: {
    lessons: [
      ...
      {
        number: 6, title: "Incident Response: What to Do After a Breach", timeEstimate: "10 min",
        sections: [
          { heading: "The First Hour Matters Most", content: "If you suspect an account or device has been compromised, speed limits the damage. Immediate steps in order:\n1. Change the password for the compromised account FROM A DIFFERENT, TRUSTED DEVICE\n2. If you reused that password anywhere else, change it everywhere — assume it's now public\n3. Enable or re-verify 2FA on the account\n4. Check account activity/login history for unfamiliar sessions and log them out remotely\n5. Contact the platform's fraud/security team if money or crypto is involved" },
          { heading: "If Financial Accounts Are Involved", content: "• Call your bank/card issuer immediately to freeze the card and dispute unauthorized charges — the Fair Credit Billing Act limits your liability if reported quickly\n• Place a fraud alert or credit freeze with all three credit bureaus (Experian, Equifax, TransUnion) — free, and prevents new accounts being opened in your name\n• File a report at IdentityTheft.gov (FTC) — this generates an official recovery plan and affidavit useful for disputing fraudulent accounts\n• For crypto: unlike bank fraud, blockchain transactions cannot be reversed — your only real protection is prevention (this is why seed phrase security matters so much)", isWarning: true },
          { heading: "Documenting the Incident", content: "Keep records as you respond — screenshots of suspicious emails/messages, dates and times of actions taken, names of any support agents you spoke with, and confirmation numbers. This documentation is essential if you need to dispute charges, file a police report, or later discover the breach caused other downstream fraud." },
        ],
        keyTakeaways: ["Speed matters — change passwords from a trusted device and enable 2FA within the first hour of suspecting a breach", "Freeze credit with all three bureaus and file at IdentityTheft.gov if financial fraud occurred", "Crypto transactions can't be reversed — prevention (seed phrase security) is your only real protection there"],
      },
      {
        number: 7, title: "Privacy & Security for Small Business Owners", timeEstimate: "9 min",
        sections: [
          { heading: "Business Data Carries Extra Responsibility", content: "The moment you collect any customer, client, or workshop-attendee data (names, emails, phone numbers), you take on responsibility for protecting it — and potential legal exposure if it's breached. This applies to VEDD ambassadors running workshops just as much as larger businesses." },
          { heading: "Practical Small-Business Privacy Practices", content: "• Collect only the data you actually need — don't ask for a Social Security Number to register for a free workshop\n• Store contact lists in a reputable platform (Google Sheets with restricted sharing, a CRM like HubSpot free tier) rather than scattered across personal notes apps\n• Get explicit consent before adding someone to an email list — a sign-in sheet at a workshop is not automatic consent to be emailed marketing content\n• Have a simple, published privacy statement telling people what data you collect and how it's used — even one paragraph builds trust and reduces liability" },
          { heading: "Separating Business and Personal Security", content: "Use a separate business email and, ideally, a separate device or browser profile for business activities. This limits the blast radius if either side is compromised, and makes it easier to maintain professional boundaries and accurate records for tax and grant-reporting purposes.", isExample: true },
        ],
        keyTakeaways: ["Collecting any personal data creates a responsibility to protect it — collect only what you truly need", "Get explicit consent before adding anyone to a marketing or newsletter list", "Separate business and personal accounts/devices to limit risk and keep records clean"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "Why can't a stolen cryptocurrency transaction typically be reversed, unlike a fraudulent bank charge?", options: ["Crypto exchanges refuse to help", "Blockchain transactions are permanent and irreversible by design — there is no central authority to reverse them", "It's illegal to reverse crypto transactions", "Banks are always faster than blockchains"], correct: 1, explanation: "Blockchains are designed to be immutable and decentralized — no central authority can reverse a confirmed transaction. This is why prevention (seed phrase security, verifying contracts) matters far more in crypto than in traditional banking." },
        { q: "What should a small business or workshop organizer do before adding an attendee's email to a marketing list?", options: ["Nothing — a sign-in sheet is automatic consent", "Get explicit consent for marketing communications, separate from event sign-in", "Only add emails from paying customers", "Wait one year before emailing anyone"], correct: 1, explanation: "A workshop sign-in sheet is not automatic consent to receive marketing emails. Explicit, separate consent should be obtained before adding anyone to an ongoing marketing or newsletter list." },
      ],
    },
  },
  ...
  12: {
    lessons: [
      ...
      {
        number: 7, title: "Marketing on a Nonprofit or Bootstrap Budget", timeEstimate: "10 min",
        sections: [
          { heading: "Free Marketing Channels That Actually Work", content: "You don't need an ad budget to build an audience:\n• Local Facebook groups and NextDoor — hyper-local reach for workshop announcements\n• Partner cross-promotion — co-host with a complementary organization and split the promotion work\n• Email list — the highest-ROI channel you own outright, unlike social media algorithms that change constantly\n• Local press — small newspapers and community radio often cover free community education programs; a short, specific pitch ('Free financial literacy workshop helps 40 families in [neighborhood]') gets picked up more than generic pitches" },
          { heading: "Content That Builds Trust Before the Ask", content: "The 80/20 rule for community-facing content: 80% should be genuinely useful (a budgeting tip, a credit myth debunked, a real community success story) with no ask attached. Only 20% should be direct promotion of your workshop or VEDD referral link.\n\nThis builds trust with an audience that has often been targeted by predatory financial marketing — leading with value rather than a sales pitch is what makes people actually show up." },
          { heading: "Tracking What Works Without Paid Tools", content: "Free tracking that's enough for a bootstrap operation:\n• A UTM-tagged link (free, via Google's Campaign URL Builder) on every post so you know which channel drove sign-ups\n• A simple 'How did you hear about us?' field on every registration form\n• Google Analytics (free tier) on any landing page or lead page you use\n\nYou don't need enterprise marketing software — you need consistent, simple tracking applied every time.", isExample: true },
        ],
        keyTakeaways: ["Free channels (local groups, partnerships, email list, local press) can build real reach without ad spend", "Lead with genuinely useful content 80% of the time — only 20% should be direct promotion", "Simple free tools (UTM links, a 'how did you hear about us' field) are enough to know what's working"],
      },
      {
        number: 8, title: "Scaling Your Ambassador Business: From Solo to Sustainable", timeEstimate: "11 min",
        sections: [
          { heading: "The Three Growth Ceilings", content: "Every solo operator hits predictable ceilings:\n1. Time ceiling — you personally can only deliver so many workshops/calls per week\n2. Knowledge ceiling — you can't be the expert on everything your community needs\n3. Trust ceiling — your personal network eventually saturates\n\nEach ceiling requires a different solution: systematize to break the time ceiling, partner or specialize to break the knowledge ceiling, and build referral/content channels to break the trust ceiling." },
          { heading: "From Solo to Team Without Overextending", content: "Scale gradually and only with proven revenue:\n1. First: a virtual assistant for scheduling, email, and basic admin (5-10 hrs/week)\n2. Next: a co-facilitator for workshops — someone you train on your exact curriculum so quality stays consistent\n3. Later: a part-time community manager if you're running an active referral pipeline and social presence\n\nRule: never hire based on projected future revenue — hire based on revenue you're already consistently generating today." },
          { heading: "Building Recurring Revenue Into Your Model", content: "One-time workshops create one-time income. Recurring revenue creates stability:\n• Retainer relationships with employers for quarterly financial wellness sessions\n• A paid monthly community membership (deeper content, group coaching) alongside free public workshops\n• Ongoing grant-funded programs with multi-year funding cycles, rather than one-off grants\n\nA mix of free community impact work, one-time paid engagements, and recurring revenue is the healthiest long-term model — it funds the mission while providing income stability.", isExample: true },
        ],
        keyTakeaways: ["Solo operators hit predictable time, knowledge, and trust ceilings — each needs a different scaling solution", "Hire based on revenue you already have, not projected revenue — VA first, then co-facilitator, then community manager", "Blend free impact work, one-time paid engagements, and recurring revenue for a sustainable long-term model"],
      },
    ],
    assessment: {
      passingScore: 70,
      ...
      questions: [
        ...
        { q: "What is the recommended content mix for building trust before promoting your workshops or referral link?", options: ["100% promotional content to maximize sign-ups", "80% genuinely useful content, 20% direct promotion", "50/50 split between useful content and promotion", "Only post when you have a workshop coming up"], correct: 1, explanation: "The 80/20 rule builds trust before the ask — 80% of content should be genuinely useful with no ask attached, with only 20% direct promotion. This matters especially in communities that have been targeted by predatory financial marketing." },
        { q: "What is the correct order for scaling a solo ambassador business into a team?", options: ["Hire a community manager first, then a VA", "Hire based on projected future revenue to get ahead of growth", "Virtual assistant first, then a trained co-facilitator, then a community manager — based on revenue you already have", "Hire a full-time employee immediately for stability"], correct: 2, explanation: "Sustainable scaling starts with a VA for admin tasks, then a trained co-facilitator to maintain quality at scale, then a community manager if needed — and each hire should be justified by revenue you're already consistently generating, not projected revenue." },
      ],
    },
  },
  // ── Course 13: VEDD Platform Power Features ───────────────────────────────
  13: {
    lessons: [
      {
        number: 1, title: "Automatic Trade Logging & the Paper Trade AI Journal", timeEstimate: "10 min",
        sections: [
          { heading: "Why Trade Journals Fail", content: "Every serious trader is told to keep a journal. Almost nobody does — because manual logging is tedious, and the trades people skip logging are exactly the losses they'd rather forget. A journal with gaps teaches the wrong lessons." },
          { heading: "How VEDD Logs Trades Automatically", content: "Connect a TradeLocker or MT5 account once. Every 20 seconds, VEDD checks your open positions. A new position gets recorded the moment it appears. When it disappears from the open list — closed manually, stopped out, or target hit — VEDD pulls the real profit or loss straight from your broker and marks the outcome.\n\nNo typing. No spreadsheets. No cherry-picking. What your broker shows is what your journal shows." },
          { heading: "Real Example: The Auto-Synced Tag", content: "Open your Trade Performance card and look at the last 5 trades. Trades recorded by the automatic sync carry an 'Auto-Synced' tag. Trades pushed by the MT5 EA show 'Auto (MT5)'. You always know how each record got there.", isExample: true },
          { heading: "The Paper Trade AI Journal", content: "Separately, every trade the AI confirms is recorded as a paper trade — a parallel journal of what the AI's calls would have produced. Entries resolve automatically against live prices at the 1-hour, 4-hour, and 24-hour marks: WIN, LOSS, or BREAKEVEN, with pips.\n\nThe AI reads its own accuracy history back into future decisions. A weak streak on GBPUSD sells makes it more cautious on the next GBPUSD sell — automatically." },
          { heading: "Why This Feeds the Brain", content: "VEDD's learning brain studies your complete trade history to find your real winning patterns: which sessions, which confluence grades, which directions. Automatic logging means the brain learns from ALL your trades — not just the ones you remembered to write down after a good week.", isWarning: false },
        ],
        keyTakeaways: ["Trades log themselves every 20 seconds from connected accounts — zero manual entry", "Outcomes come straight from your broker, so your record can't lie", "The Paper Trade AI Journal tracks the AI's own accuracy and feeds it back into future decisions"],
      },
      {
        number: 2, title: "The Brain Data Marketplace", timeEstimate: "10 min",
        sections: [
          { heading: "The Cold-Start Problem", content: "VEDD's AI gets smarter about YOUR trading as your trade history grows — it learns which sessions, pairs, and setups actually win for you. But a brand-new trader starts with zero history, which means zero learned patterns. That's the cold-start problem." },
          { heading: "How the Marketplace Solves It", content: "Established traders can list a snapshot of their trade history for sale, priced in VEDD tokens. A newcomer buys a copy, and it merges into their own learning brain instantly — their AI starts with proven patterns instead of a blank slate.\n\nKey design: the sale is non-exclusive. The seller keeps their own data and can sell the same listing to unlimited buyers. Data isn't like a physical good — copying it costs the seller nothing." },
          { heading: "How Pricing Works", content: "Prices are computed automatically from four factors:\n• Age of the data (older, longer track records are worth more)\n• Number of distinct pairs traded\n• Total trade count\n• Win rate\n\nThe formula clamps between 5 and 500 VEDD. Sellers can set their own price within that range; the suggested price is shown before listing." },
          { heading: "Real Example: Buying a Brain", content: "You find a listing: 85 trades, 6 pairs, 120 days old, 63% win rate, priced at 74 VEDD. You click Buy. The VEDD leaves your wallet, the seller gets paid, and 85 trade records merge into your brain tagged 'purchased_brain' — your AI now recognizes that trader's winning patterns while still tracking your own organic trades separately.", isExample: true },
          { heading: "The Guardrails", content: "• Minimum 10 completed trades to list — no empty data for sale\n• You cannot buy your own listing\n• You cannot re-sell data you purchased — only organic history counts toward a listing\n• Double-purchase is blocked; you can't accidentally buy the same listing twice\n• Purchases are blocked if your wallet balance is insufficient", isWarning: true },
        ],
        keyTakeaways: ["The marketplace lets newcomers bootstrap their AI with proven trade history", "Sales are non-exclusive — sellers keep their data and earn from every buyer", "Pricing is formula-driven: age × pairs × trades × win rate, clamped 5–500 VEDD"],
      },
      {
        number: 3, title: "Copy Trading: Paper Mode and Real Mode", timeEstimate: "12 min",
        sections: [
          { heading: "What Copy Trading Actually Does", content: "Copy trading mirrors another trader's positions onto your own account automatically. On VEDD, you browse a leaderboard of traders ranked by real win rate, pick one, set your risk limits, and every trade they open gets mirrored to you — at YOUR lot size, never theirs." },
          { heading: "Paper Mode: Evaluate Before You Commit", content: "In Paper mode, copied trades mirror into your simulated paper account. Your paper balance moves with real market prices, but no real money is at risk. This is the professional way to evaluate a trader: watch their calls play out on your own account for a few weeks before considering real money.\n\nThe leader still earns their VEDD subscription fee and profit share — so paper copiers are real customers, not freeloaders." },
          { heading: "Real Mode: Live Execution With Hard Gates", content: "In Real mode, copied trades are placed as live orders on your connected TradeLocker account. Because real money moves automatically, every trade must pass hard safety gates first:\n• Your account data must be fresh (no stale snapshots)\n• Positive balance and free margin required\n• Margin level must be above the 200% safety floor\n• Your Max Lot Size caps every trade, no exceptions\n• A daily-loss backstop pauses copying for the day at -10%" },
          { heading: "Real Example: A Skipped Copy", content: "Your leader opens 0.5 lots on XAUUSD. Your Max Lot Size is 0.05, so your mirror would be 0.05 lots — but your margin level is at 180%, below the 200% floor. The trade is SKIPPED, and the reason ('Margin level 180% below 200% safety floor') is recorded on your copy log. The system chose protecting your account over following the leader.", isExample: true },
          { heading: "The Economics", content: "Starting a copy relationship costs a one-time VEDD subscription fee (paid to the trader). On winning copied trades, the trader earns a profit share (default 20%) paid in VEDD, scaled to YOUR actual P&L — if you ran a smaller lot than the leader, the share is proportionally smaller.", isWarning: false },
        ],
        keyTakeaways: ["Paper mode mirrors trades into your simulated account — evaluate any trader risk-free", "Real mode places live orders behind hard safety gates that cannot be overridden", "Your Max Lot Size is an absolute cap; skipped trades always show the reason why"],
      },
      {
        number: 4, title: "Deep Reasoning Mode: The Veteran Judge", timeEstimate: "12 min",
        sections: [
          { heading: "The Problem With One-Shot AI Decisions", content: "A standard AI trade confirmation is a single pass: the model reads the chart data, indicators, and rules, then outputs a decision. It works, but it has a known weakness — a single pass tends to be agreeable. It looks for reasons the setup works rather than genuinely stress-testing it." },
          { heading: "The Debate Structure", content: "Deep Reasoning Mode replaces the single pass with a structured debate, modeled on how elite trading desks actually make decisions:\n\n1. BULL CASE — one AI pass argues FOR taking the trade, as rigorously as possible\n2. BEAR CASE — a second pass argues AGAINST it, hunting for every structural risk\n3. VETERAN JUDGE — a chain-of-thought reasoning model weighs both cases and makes the final call\n\nThis mirrors the Bull/Bear/Judge pattern used by leading open-source trading AI frameworks." },
          { heading: "Who the Veteran Judge Is", content: "The judge runs under a persona: a trader with 30+ years of consistent profitability across every market regime. Its defining traits are deliberate:\n• Capital preservation over profit, always\n• Far more likely to skip a setup than take it\n• Zero ego — if the bear case is stronger, the answer is no\n• Never widens risk to chase, never overrides structure with feelings\n\nIt runs on a true reasoning model (deep chain-of-thought), not a fast chat model — it thinks step-by-step before committing." },
          { heading: "Real Example: An Audited Decision", content: "EURUSD BUY signal at 74% confidence. Bull case: London breakout with HTF alignment and clean order block. Bear case: high-impact USD news in 40 minutes, RSI divergence on H4. The Veteran Judge weighs both, reasons through the news risk, and REJECTS — 'the bull case is real but the news risk violates capital preservation; re-evaluate after the release.' The full reasoning trail is saved with the decision.", isExample: true },
          { heading: "When to Use It", content: "Deep Reasoning Mode is a toggle in the Prop Firm Challenge dashboard settings. It's slower and costs more per confirmation than the fast path — so use it where decisions matter most: live accounts, prop firm challenges, larger position sizes. For high-frequency paper scanning, the fast path is usually the right trade-off.", isWarning: true },
        ],
        keyTakeaways: ["Deep Reasoning runs a Bull vs Bear debate judged by a veteran-trader reasoning model", "The judge is deliberately biased toward skipping — capital preservation first", "Every decision's full reasoning trail is saved and auditable"],
      },
      {
        number: 5, title: "Passing Prop Firm Challenges: The Consistency Toolkit", timeEstimate: "12 min",
        sections: [
          { heading: "Why Most Traders Fail Challenges", content: "Prop firm statistics are brutal: the large majority of challenge attempts fail. The #1 killer isn't bad analysis — it's rule violations. Traders hit the daily drawdown limit on one bad day, or pass the profit target but fail a consistency rule they didn't manage. The firms design the rules to filter out gamblers; VEDD's toolkit is designed to make the engine trade like the disciplined minority who pass." },
          { heading: "The 80% Drawdown Buffer", content: "When Prop Firm Mode is on, the engine doesn't trade to the edge of your firm's daily drawdown limit — it stops at 80% of it. If your firm allows 5% daily drawdown, VEDD halts at 4%.\n\nWhy: floating P&L, spread widening, and slippage can push you past a limit you thought you hadn't hit. Experienced challenge-passers never ride the wall; they leave a buffer." },
          { heading: "The Two Consistency Rules", content: "VEDD enforces both common consistency rule types:\n\n1. PROFITABLE DAYS QUOTA (Earn2Trade-style): e.g. 10 of 15 days must be profitable. The engine tracks your quota and automatically cuts risk to 50% — then 25% — when you can't afford another losing day.\n\n2. MAX SINGLE-DAY PROFIT (FTMO-style): no single day may exceed X% of your total profit. This is tracked per account in a durable ledger, one row per account per day — it survives deploys and restarts, so a multi-week challenge never silently resets to zero mid-way through. As today's gain approaches your cap, position sizing on that account tapers down automatically; if today's gain actually reaches the cap, new trades are blocked on that account until the next trading day. Nothing already banked is touched — the ratio comes back down naturally as future days add to your total profit." },
          { heading: "Not Every Firm Has This Rule", content: "Some prop firms don't enforce a max-single-day-profit rule at all — forcing it on an account that doesn't need it just costs you trading opportunity for no reason. That's why the consistency rule is a per-account switch, not a platform-wide setting: turn it ON for accounts whose firm enforces it, OFF for accounts whose firm doesn't. Each account can also have its own % cap, since firms differ (commonly 20–50%).", isWarning: true },
          { heading: "Real Example: The Near-Target Trim", content: "Your challenge target is $8,000 and you've banked $6,500 — 81% of the way there. VEDD automatically trims risk to half. The logic: at 81% of target, the remaining upside of aggressive sizing is small, but one oversized loss could undo weeks of work. Protect the finish line.", isExample: true },
          { heading: "Setting It Up", content: "Prop Firm Mode + daily drawdown live in the Prop Firm Challenge dashboard. The consistency rule lives on the account itself:\n• Open the account's detail page → Consistency Monitor card\n• Flip the switch on/off depending on whether your firm enforces the rule\n• Set the account's own cap % to match your firm's exact rule\n• The card shows your live ratio, today's P&L vs. total profit, and plain-English guidance on why the engine is (or isn't) tapering size right now — no guessing why a trade got smaller or skipped\n• Optionally enable the Session Filter (London–NY overlap only) and Deep Reasoning Mode for maximum discipline", isWarning: false },
        ],
        keyTakeaways: ["The engine stops at 80% of your firm's drawdown limit — never rides the edge", "Consistency enforcement is per-account (durable, survives restarts) with its own on/off switch and cap % — not a single platform-wide setting", "The account's Consistency Monitor always shows WHY size is being tapered or trades blocked, in plain English", "Risk trims automatically near your profit target — protecting the finish line like a veteran"],
      },
    ],
    assessment: {
      passingScore: 70,
      certTitle: "VEDD Platform Power Features — VEDD Certified",
      questions: [
        { q: "How does VEDD's automatic trade logging detect that a trade closed?", options: ["The user marks it closed in the app", "The broker sends VEDD an email notification", "VEDD polls open positions every 20 seconds — a position that disappears from the open list is detected as closed, and the real P&L is pulled from the broker", "The MT5 EA must be attached to every chart"], correct: 2, explanation: "The sync loop polls each connected account every 20 seconds. New positions are recorded on first sight; a previously-open position that's gone from the list is marked closed with the broker's actual realized P&L." },
        { q: "When you sell your brain data on the Brain Data Marketplace, what happens to your own data?", options: ["It transfers to the buyer and you lose access", "You keep it — the buyer gets a snapshot copy, and you can sell the same listing to unlimited buyers", "It's split 50/50 between you and the buyer", "It's locked until the buyer finishes using it"], correct: 1, explanation: "Sales are non-exclusive copies. The listing freezes a snapshot of your history at listing time; every buyer gets a copy merged into their own brain, and your own data never leaves your account." },
        { q: "In Real-mode copy trading, what happens if your margin level is below the 200% safety floor when the leader opens a trade?", options: ["The trade executes at half size", "The trade executes but with a tighter stop loss", "The trade is skipped entirely and the reason is recorded on your copy log", "You get a notification asking for manual approval"], correct: 2, explanation: "Real-mode safety gates are hard blocks, not adjustments. A failed gate (stale data, no free margin, margin level under 200%, daily-loss backstop) skips the trade completely and records exactly why." },
        { q: "What makes the Veteran Judge in Deep Reasoning Mode different from a standard AI confirmation?", options: ["It uses a bigger prompt with more indicators", "It weighs an explicit Bull Case against a Bear Case using a chain-of-thought reasoning model, with a persona deliberately biased toward skipping marginal setups", "It always confirms trades faster", "It only trades during London session"], correct: 1, explanation: "Deep Reasoning replaces the single agreeable pass with a structured debate. The judge persona — a 30-year consistently profitable veteran — prioritizes capital preservation and says no whenever the bear case is stronger, then saves the full reasoning trail." },
        { q: "Your prop firm allows 5% daily drawdown. At what actual loss does VEDD's engine stop trading for the day in Prop Firm Mode?", options: ["Exactly 5%", "4% — the engine stops at 80% of the firm's limit to leave a buffer for slippage and floating P&L", "2.5%", "It never stops automatically"], correct: 1, explanation: "The engine enforces 80% of the firm's stated limit (5% × 0.8 = 4%). Spread widening, slippage, and floating losses can push past a limit you thought you hadn't hit — experienced challenge-passers never ride the wall." },
        { q: "What does the Max Single-Day Profit consistency rule protect against?", options: ["Losing too much in one day", "Trading during news events", "Failing a firm's payout-eligibility rule that no single day may account for too much of your total profit", "Over-trading low-confidence setups"], correct: 2, explanation: "Some firms (FTMO-style) deny payouts if one day's profit is too large a share of the total — it looks like gambling, not consistency. VEDD tapers position size as today's gain approaches your configured cap, then blocks new trades on that account once it's reached — tracked durably per account so it survives restarts, and it's a per-account switch since not every firm enforces this rule." },
      ],
    },
  },
};
...
const COURSES = [
  { id: 1, title: "AI Literacy 101", category: "ai_literacy", difficulty: "beginner", minutes: 66, description: "Understand how AI works, bias, responsible use, and AI tools for nonprofits and your financial future.", grantTags: ["NSF", "DOL"], audience: "all", icon: "Brain", color: "#6366f1", lessons: 8, enrolled: 342 },
  { id: 2, title: "Digital Skills Foundations", category: "digital_skills", difficulty: "beginner", minutes: 79, description: "Core digital literacy: internet safety, productivity tools, accessibility, remote work, and data basics.", grantTags: ["DOL", "CDFI"], audience: "community", icon: "Monitor", color: "#06b6d4", lessons: 7, enrolled: 218 },
  { id: 3, title: "Trading Fundamentals", category: "trading_fundamentals", difficulty: "beginner", minutes: 113, description: "Forex market structure, candlestick charts, support/resistance, ICT methodology, risk management, and trading plans.", grantTags: ["SBA"], audience: "all", icon: "TrendingUp", color: "#22c55e", lessons: 7, enrolled: 567 },
  { id: 4, title: "Financial Planning & Literacy", category: "financial_planning", difficulty: "beginner", minutes: 106, description: "Mindset, budgeting systems, credit scores, debt elimination, retirement investing, and insurance.", grantTags: ["CDFI", "DOL"], audience: "community", icon: "DollarSign", color: "#f59e0b", lessons: 6, enrolled: 423 },
  { id: 5, title: "Web3 & Blockchain Basics", category: "web3_basics", difficulty: "intermediate", minutes: 84, description: "Cryptocurrency wallets, DeFi lending/staking, NFTs, Solana ecosystem, and VEDD token economics.", grantTags: ["NSF", "EDA"], audience: "all", icon: "Coins", color: "#a855f7", lessons: 8, enrolled: 189 },
  { id: 6, title: "STEM for Young Traders", category: "stem", difficulty: "beginner", minutes: 49, description: "Math, statistics, probability, and fintech career paths for youth (ages 13-21) applied to markets and money.", grantTags: ["NSF", "DOL"], audience: "youth", icon: "GraduationCap", color: "#ec4899", lessons: 7, enrolled: 156 },
  { id: 7, title: "AI Ethics in Finance", category: "ai_literacy", difficulty: "intermediate", minutes: 66, description: "Bias, fairness, transparency, real-world case studies, and building ethical AI policies for your organization.", grantTags: ["NSF", "NIST"], audience: "all", icon: "Shield", color: "#ef4444", lessons: 7, enrolled: 98 },
  { id: 8, title: "Job Readiness & Portfolio Building", category: "digital_skills", difficulty: "beginner", minutes: 112, description: "Resume building, interview skills, salary negotiation, personal branding, and digital portfolio creation.", grantTags: ["DOL", "WIA"], audience: "community", icon: "Briefcase", color: "#06b6d4", lessons: 8, enrolled: 134 },
  { id: 9, title: "Advanced AI Trading Strategies", category: "trading_fundamentals", difficulty: "advanced", minutes: 148, description: "ICT methodology deep dive, SMC order blocks, multi-timeframe confluence, custom indicators, and backtesting with AI.", grantTags: ["NSF", "EDA"], audience: "ambassador", icon: "LineChart", color: "#22c55e", lessons: 9, enrolled: 87 },
  { id: 10, title: "Community Finance Leadership", category: "financial_planning", difficulty: "intermediate", minutes: 95, description: "Lead financial wellness workshops, credit co-ops, investment clubs, nonprofit formation, board governance, and grant writing.", grantTags: ["CDFI", "USDA"], audience: "ambassador", icon: "Users", color: "#f59e0b", lessons: 8, enrolled: 73 },
  { id: 11, title: "Data Privacy & Cybersecurity", category: "digital_skills", difficulty: "intermediate", minutes: 64, description: "Protect personal data, understand GDPR/CCPA, spot phishing, respond to breaches, and secure a small business.", grantTags: ["NSF", "CISA"], audience: "all", icon: "Lock", color: "#06b6d4", lessons: 7, enrolled: 211 },
  { id: 12, title: "Entrepreneurship & VEDD Business Launch", category: "financial_planning", difficulty: "intermediate", minutes: 111, description: "LLC formation, business credit, grants, bootstrap marketing, scaling your team, and the VEDD ambassador business model.", grantTags: ["SBA", "EDA"], audience: "ambassador", icon: "Rocket", color: "#f59e0b", lessons: 8, enrolled: 95 },
  { id: 13, title: "VEDD Platform Power Features", category: "trading_fundamentals", difficulty: "intermediate", minutes: 56, description: "Automatic trade logging, the Brain Data Marketplace, copy trading with real-broker safety gates, Deep Reasoning Mode, and the prop firm consistency toolkit.", grantTags: ["SBA"], audience: "all", icon: "Brain", color: "#a855f7", lessons: 5, enrolled: 12 },
];
