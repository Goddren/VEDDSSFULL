...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    detail: 'The VEDD SS AI page runs a live trading engine across major forex pairs. It uses 18 HFT strategies, a self-learning brain that studies historical trades, and weekly profit goal tracking. First, connect your MT5 or TradeLocker account so it has real data to work with.',
    cta: { label: 'Connect MT5 / TradeLocker', path: '/mt5-chart-data' },
    color: 'text-cyan-400',
