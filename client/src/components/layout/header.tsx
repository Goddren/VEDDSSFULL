...
const Header: React.FC = () => {
  ...
  const moreNavItems = [
    ...
    { name: 'Crypto AI Engine', path: '/crypto-engine', active: location === '/crypto-engine', icon: <Coins className="h-4 w-4 mr-2" /> },
    { name: 'DXtrade (Velotrade)', path: '/dxtrade', active: location === '/dxtrade', icon: <TrendingUp className="h-4 w-4 mr-2" /> },
  ...
  const menuGroups: { title: string; items: { name: string; path: string; Icon: React.ComponentType<{ className?: string; style?: React.CSSProperties }>; color: string }[] }[] = [
    { title: 'Trading Engines', items: [
      ...
      { name: 'Crypto AI Engine', path: '/crypto-engine', Icon: Coins, color: '#f59e0b' },
