...
export default defineConfig({
  ...
  build: {
    ...
    rollupOptions: {
      output: {
        // Reverted to the original object-form manualChunks — the function-form
        // catch-all 'vendor' chunk broke module init order at runtime (blank
        // page). This is the known-good config.
        manualChunks: {
