...
// Simple tooltip component that doesn't rely on any imports from the tooltips directory
const MarketTooltip: React.FC<{
...
export default function WorkingTooltips() {
      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">
            Interactive tooltips that provide contextual information for market data and insights
          </p>
        </div>
      </div>
